...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('documents', function (Blueprint $table) {
            ...
            $table->foreignId('current_office_id')->constrained('offices')->onDelete('cascade'); // ✅ corregido
            ...
            $table->enum('status', ['registrado', 'en_proceso', 'cancelado', 'finalizado', 'rechazado'])
                ->default('registrado');
